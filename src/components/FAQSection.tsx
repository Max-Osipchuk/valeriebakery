...
export const faqData = [
  ...
  },
  {
    ...
    answer:
      "Самовывоз — бесплатно. Доставка по Санкт-Петербургу осуществляется через Яндекс Доставку: стоимость рассчитывается по тарифам сервиса и зависит от адреса — точную сумму назовём при подтверждении заказа. Торт передаём в надёжной упаковке, которая сохраняет декор в пути.",
  },
];
